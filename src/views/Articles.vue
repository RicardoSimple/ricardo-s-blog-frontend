        ...
        <article class="hentry">
          ...
          <header class="entry-header">
            ...
            <div class="breadcrumbs">
              <div id="crumbs">最后更新时间：{{ format(article.gmtModified) }}</div>
            </div>
          </header>
          <!-- 正文输出 -->
          <div
 ...
 make linux test #安装&amp;测试</code></pre>
            ...
            <ol>
              <li>没有gcc命令(lua是C语言编写的，安装时依赖gcc)
                <blockquote>
                  <p>使用<code>which gcc</code>命令可以查看是否有gcc，如果没有使用下面命令进行安装gcc
                    与gcc-c++，</p>
            ...
            <ol start="2">
              <li>致命错误：readline/readline.h：没有那个文件或目录
                <blockquote>
                  <p>执行如下命令即可:</p>
                  <pre
                    class="lang-shell"><code>yum install libtermcap-devel ncurses-devel libevent-devel readline-devel</code></pre>
                </blockquote>
              </li>
            </ol>
            <hr>
          ...
          <section-title>
            <footer class="post-footer">
              ...
              >
                ...
                <ul
                  class="donate_inner"
                  :class="{'show':showDonate}"
                >
                  <li class="wedonate"><img
                      src="http://cdn.fengziy.cn/gblog/wexin_pay.png"
                    >
                    <p>微信</p>
                  </li>
                  <li class="alidonate"><img
                      src="http://cdn.fengziy.cn/gblog/ali_pay.jpg"
                    >
                    <p>支付宝</p>
                  </li>
                </ul>
...
import { getArticleById } from '../api/articleApi/articleApi'
...
export default {
  ...
  methods: {
    ...
    addContent () {
      ...
      console.log(e)
      e.innerHTML = this.article.content
      this.createMenus()
    }
  },
  created () {
